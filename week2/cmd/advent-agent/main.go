...
func main() {
	...
	api := agent.NewAPIClient(cfg.Daemon.SocketPath, 10*time.Second).WithProfile(profile)
...
func ensureDaemon(api *agent.APIClient, cfg agent.Config) error {
	...
	if os.Getenv("DEEPSEEK_API_KEY") == "" {
		return errors.New("cannot auto-start advent-agentd: DEEPSEEK_API_KEY is not exported in this shell")
	}
